...
# No leaky drawers: self memory watchdog (torch/YOLO can balloon; backstops PM2).
try:
    import mem_guard
    mem_guard.install(label="yolo", limit_mb=int(os.environ.get("YOLO_MEM_LIMIT_MB", "2500")))
except Exception:
    pass
import traceback
