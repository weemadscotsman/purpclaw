...
const SERVICE_CONFIG = [
  ...
  { name: 'Knowledge Pool',      port: 7885, path: '/health',         key: 'pool',             optional: false, note: '44-entry routing table' },
  { name: 'Context Bus',         port: 7881, path: '/health',         key: 'context',          optional: false, note: 'inter-service context handoff' },
  { name: 'Worker Pool',         port: 7897, path: '/health',         key: 'workers',          optional: false, note: 'remote worker dispatch' },
  ...
  // ── Cognitive (5) ────────────────────────────────────────────────────────
  { name: 'Memory Matrix v2',    port: 7880, path: '/health',         key: 'memory',           optional: false, note: 'long-term memory store (Python)' },
  { name: 'Neuro-Symbolic',      port: 7884, path: '/health',         key: 'bridge-ns',        optional: false, note: 'symbolic ↔ neural bridge' },
  { name: 'Modal Logic Engine',  port: 7785, path: '/health',         key: 'modal',            optional: false, note: 'modal logic reasoner' },
  { name: 'Autonomous Diag.',    port: 7786, path: '/health',         key: 'diagnostics',      optional: false, note: '5-agent runtime diagnostics' },
  { name: 'Symbolic Rules',      port: 7787, path: '/health',         key: 'rules',            optional: false, note: 'Prolog rules engine' },
