...
export async function GET() {
  ...
  try {
    const [api, tower, bus, pipeline, kernel, omnicode, delegation, llmStatus, researchStatus] = await Promise.all([
      ...
      getJson('http://127.0.0.1:7780/api/kernel/jobs?limit=20', { jobs: [] }),
