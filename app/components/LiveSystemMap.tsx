...
export function LiveSystemMap({ data }: { data: MissionData }) {
  ...
  // ⚡ Bolt: Memoize the deduplicated agents list to avoid redundant O(N) passes.
  // Previously, uniqueAgents(data.agents) was called three times across multiple useMemo hooks.
