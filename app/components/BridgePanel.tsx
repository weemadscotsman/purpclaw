...
const PROVIDER_DEFAULTS: Record<Provider, { label: string; models: string[]; needsKey: boolean }> = {
  nvidia: {
    label: 'NVIDIA NIM',
    needsKey: true,
    models: [
        ...
        <div className="p-3 border-b border-zinc-800 bg-zinc-900/60">
          <div className="flex items-center gap-2 mb-2">
            ...
            {providerDef.needsKey && (
              <span className="text-xs px-1.5 py-0.5 rounded bg-yellow-500/20 text-yellow-400">needs key</span>
            )}
          </div>
