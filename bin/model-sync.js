#!/usr/bin/env node
/**
 * bin/model-sync.js — PURPCLAW model sync + auto-update for NIM/OpenRouter/HF.
 *
 ...
 *
 * Cron:
 *   0 6 * * *  node bin/model-sync.js --check    # daily 6am
 *
 * v1.0 — first ship.
 */
...
const STATE_DIR = path.join(PURP, 'agent_work', 'model-syncy');
...
function log(...args) {
  console.log(`[model-sync ${new Date().toISOString()}]`, ...args);
}
