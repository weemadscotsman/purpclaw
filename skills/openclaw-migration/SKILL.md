...
Legacy/reference-only migration material. This skill is quarantined from PURPCLAW native skill registration and must not define PURPCLAW runtime identity.
