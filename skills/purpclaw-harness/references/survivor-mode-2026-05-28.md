# Survivor Mode Router + Provider Health Registry (2026-05-28)
...
Current registry (May 28 2026):
| Provider | State | Notes |
|---------|-------|-------|
| openrouter | unknown | local broker |
| codex | quota_dead | reset May 31 2026 14:06 |
| minimax | unknown | primary agent |
| deepseek | unknown | fallback |
| hermes | unknown | broker |
| local | unknown | |
| claude | unknown | |
