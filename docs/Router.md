...
Keywords: `speech`, `voice`, `audio`, `stt`, `tts`, `transcribe`, `speak`, `listen`, `kokoro`, `whisper`
Path: `divisions/voice-infrastructure/AGENTS.md`
Agents: `voice-coordinator` (voice routing), `voice-bridge` (TTS pipeline)
