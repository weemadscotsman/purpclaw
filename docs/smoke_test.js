...
const SERVICES = [
  ...
  { name: 'PURPCLAW Gateway', port: 18789, url: 'ws://127.0.0.1:18789', type: 'websocket' },
  // 2026-06-22: Cognitive Spine was running but never health-checked.
  // The spine is the unified port for memory + rules + modal + diagnostics
  // + neuro-symbolic + autodream. If it's down, the agent loop runs blind.
  { name: 'Cognitive Spine', port: 7880, url: 'http://localhost:7880/health', type: 'http' },
  { name: 'Cognitive Rules Engine', port: 7880, url: 'http://localhost:7880/rules/health', type: 'http' },
  { name: 'Cognitive Modal Engine', port: 7880, url: 'http://localhost:7880/modal/health', type: 'http' },
  { name: 'Cognitive Diagnostics', port: 7880, url: 'http://localhost:7880/diagnostics/health', type: 'http' },
  { name: 'Cognitive Neuro-Symbolic', port: 7880, url: 'http://localhost:7880/neuro-symbolic/health', type: 'http' },
  { name: 'Cognitive AutoDream', port: 7880, url: 'http://localhost:7880/autodream/health', type: 'http' },
];
