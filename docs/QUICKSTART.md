...
3. **Boot the swarm** — PM2 starts core services, WebUI comes online at `127.0.0.1:3030`
...
- **WebUI**: `http://127.0.0.1:3030` — Mission Control dashboard
- **WebUI Mission**: `http://127.0.0.1:3030/mission` — Mission Control
