...
| Media Ops | `MEDIA_OPS` | pink | /media | duck |
...
|---|---|---|---|
| duck | MEDIA_OPS | Research Accelerant | LONGCTX (kimi-k2.6) |
...
| goose | MEDIA_OPS | Chaos Catalyst | QUICK |
...
| parrot | MEDIA_OPS | Communication Bridge | QUICK |
