...
Last verified: 2026-07-01 from live code, not older docs.
...
The declared package manager is `pnpm@9.15.0`, but the current scripts and CLI also run with `npm install`.
