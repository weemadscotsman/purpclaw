...
// Ed25519 public key (Pocket OS).
// At build/release time, run `purpclaw release keygen` to generate a real keypair,
// then paste the output here. The matching private key lives in ~/.purpclaw/keys/.
// If no key has been generated yet, verification falls through to release-sign's
// stored key (which works for developer builds and test environments).
