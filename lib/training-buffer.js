    ...
    switch (format) {
      ...
      case 'sharegpt': {
        ...
        const convs = records.filter(r => r.output).map(r => ({
          conversations: [
            { from: 'system', value: 'You are Purpclaw Mission Control. You execute work via kernel jobs, swarm missions, and group research. Be terse, accurate, and report outcomes concretely.' },
