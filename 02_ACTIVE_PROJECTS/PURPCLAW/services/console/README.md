...
```python
mcp__hermes__terminal(command="python E:/god\\ folder/02_ACTIVE_PROJECTS/PURPCLAW/services/console/__main__.py")
```
...
- `__main__.py` — `python -m services.console` entry
