...
|---|---|---|---|---|
| duck | MEDIA_OPERATIONS | research briefs, data gathering, media/data scans | question, scope, sources, output format | final security approval |
...
| goose | MEDIA_OPERATIONS | creative shakeups, alternate angles, idea expansion | theme, audience, tone boundary | precision/security-only tasks |
...
| parrot | MEDIA_OPERATIONS | translation, summaries, message adaptation | source message, target channel, tone | sending messages without confirmation |
