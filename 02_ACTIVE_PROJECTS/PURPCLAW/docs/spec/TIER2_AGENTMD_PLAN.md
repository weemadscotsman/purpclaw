...
| `lib/imagegen/` | MEDIA_OPERATIONS | SDXL/Comfy ties. |
...
| `lib/stt/`  | MEDIA_OPERATIONS | Speech-to-text (Whisper/Deepgram). |
...
| `lib/tts/`    | MEDIA_OPERATIONS | TTS (Kokoro/Coqui). |
