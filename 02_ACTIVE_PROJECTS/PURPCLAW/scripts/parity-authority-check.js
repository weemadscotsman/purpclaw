 ...
 *   coverage, public, var, research, and any directory starting with ".tmp-".
...
const EXCLUDE_DIRS = new Set([
  ...
  // var/ is generated and transient by definition (gitignored, holds logs,
  // caches and incident backups). An incident backup contains a copy of
  // docs/parity/CANONICAL_PARITY_PRIORITY.md, which made this gate report two
  // canonical claimants and fail — on a backup, not on a real second source.
  'var',
  // research/ is vendored third-party reference material, most of it another
  // project's documentation. Its parity docs are not claims about PurpClaw.
  'research',
]);
