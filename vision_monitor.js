...
const PORT = 7788;  // was 7781 — moved to avoid conflict with voice_coordinator.js TCP port 7781
...
`;
      ...
      const child = spawn('py', ['-3.11', tmpPy], { timeout: 15000, windowsHide: true });
      let stdout = '', stderr = '';
