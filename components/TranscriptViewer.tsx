    ...
    <div className="max-w-3xl mx-auto bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
      <div className="bg-gray-50 border-b border-gray-200 px-6 py-4 flex items-center justify-between">
        ...
        <button
          ...
          className="p-2 text-gray-500 hover:text-gray-700 hover:bg-gray-100 focus-visible:ring-2 focus-visible:outline-none rounded-lg transition-colors"
        >
          ...
          <div key={index} className="flex gap-4 group">
            <div className="flex-shrink-0 pt-1">
              <button
                ...
                className="flex items-center gap-1 text-xs font-medium text-blue-600 bg-blue-50 hover:bg-blue-100 focus-visible:ring-2 focus-visible:outline-none px-2 py-1 rounded transition-colors opacity-70 group-hover:opacity-100"
              >
